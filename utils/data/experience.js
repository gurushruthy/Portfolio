export const experiences = [
  ...
  },
  {
    ...
    image: '/png/oci.png',
    description: [
      'Built a Python-based backend system for an Agentic AI-powered Accounts Payable Automation Platform, orchestrating LLM agents using LangChain, LangGraph, and RAG with FAISS vector indexes.',
      'Delivered full-stack functionality including user-facing dashboards, and developed specialized agents for document parsing, compliance verification, payment scheduling, and ERP/vendor API integration—reducing invoice processing time by 60% and improving accuracy by 40%.',
  ...
  },
  {
    ...
    image: '/png/lti.png',
    description: [
      'Contributed to the Connected Elevator project as a full-stack developer, building Kafka-based real-time data streaming pipelines to ingest and process high-frequency telemetry from global elevator IoT sensors.',
      'Developed backend services to manage ingestion workflows and integrated with Azure-based storage and analytics layers.',
      'Developed resilient Kafka consumer workflows with concurrent processing and integrated dead-letter queues (DLQs) to ensure fault-tolerant message handling and observability of failed events.',
      'Handled heavy data processing pipelines by tuning Kafka\'s replication factor, partitioning strategy, and broker configurations to meet high availability (HA) and disaster recovery (DR) objectives across production clusters.',
      'Ensured exactly-once processing semantics (EOS) using Kafka transactional APIs and worked closely with the Pentaho ETL and Azure teams to streamline Kafka topic structures with downstream data transformation and storage layers, enabling consistent schema evolution and scalable data ingestion.'
    ]
  }
]
